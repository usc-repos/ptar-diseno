...
public class LodosActivadsModConv extends javax.swing.JInternalFrame {
    ...
    public void InicializarComponentes() {
        ...
        ResultSet rs;
        bod.WinLodosActivados = true;//Bandera La ventana se ha abierto
        ...
        try {
            ...
            txt_Q2C_Pregunta.setText(bod.getVarFormateada(bod.calcularQ2Cm3(), rs.getInt("decimales")));
            // - - - - - - Dato 2 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - Si CAB no tiene dato, se usa CAQ
            ...
            lbl_MGC_titulo2.setText(rs.getString("titulo2"));
            ...
            AsignarPopupBtn(btn_MAM_ayuda, rs.getString("ayuda"), rs.getString("ayudalink"), 460, 180);
            ...
            // - - - - - - Pregunta 36 Cuestionario 12 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - MAT
    ...
    private void initComponents() {
        ...
        jp_Componentes.setPreferredSize(new java.awt.Dimension(1024, 2300));
        ...
        jp_Componentes.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 2100, 120, -1));
        ...
        jp_Componentes.add(jSeparator7, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 2090, 1024, -1));
        ...
        jp_Componentes.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 2140, 120, 30));

        lbl_save_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_save_error.setText(" . . .");
        jp_Componentes.add(lbl_save_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 2100, 400, 35));

        lbl_save_error2.setForeground(new java.awt.Color(153, 0, 51));
        lbl_save_error2.setText(" . . .");
        jp_Componentes.add(lbl_save_error2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 2140, 400, 35));
        ...
        lbl_MGC_error.setText(" . . .");
        jp_Componentes.add(lbl_MGC_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 440, 340, 35));

        lbl_MGC_titulo2.setText("Titulo");
        lbl_MGC_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MGC_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 440, 80, 25));

        txt_MGC_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MGC_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 440, 130, 25));

        lbl_MGC_titulo1.setText("Titulo");
        lbl_MGC_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MGC_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 440, 300, 30));
        ...
        jp_Componentes.add(btn_MGC_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 440, 25, 25));
        jp_Componentes.add(jSeparator8, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 562, 1024, 2));

        lbl_MGA_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MGA_error.setText(" . . .");
        jp_Componentes.add(lbl_MGA_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 480, 340, 35));

        lbl_MGA_titulo2.setText("Titulo");
        lbl_MGA_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MGA_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 480, 80, 25));
        jp_Componentes.add(txt_MGA_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 480, 130, 25));

        lbl_MGA_titulo1.setText("Titulo");
        lbl_MGA_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MGA_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 480, 300, 30));

        lbl_MGL_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MGL_error.setText(" . . .");
        jp_Componentes.add(lbl_MGL_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 520, 340, 35));

        lbl_MGL_titulo2.setText("Titulo");
        lbl_MGL_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MGL_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 520, 80, 25));

        txt_MGL_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MGL_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 520, 130, 25));

        lbl_MGL_titulo1.setText("Titulo");
        lbl_MGL_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MGL_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 520, 300, 30));

        lbl_MDB_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MDB_error.setText(" . . .");
        jp_Componentes.add(lbl_MDB_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 610, 340, 35));

        lbl_MDB_titulo2.setText("Titulo");
        lbl_MDB_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MDB_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 610, 80, 25));
        jp_Componentes.add(txt_MDB_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 610, 130, 25));

        lbl_MDB_titulo1.setText("Titulo");
        lbl_MDB_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MDB_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 610, 300, 30));

        lbl_MSE_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MSE_error.setText(" . . .");
        jp_Componentes.add(lbl_MSE_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 650, 340, 35));

        lbl_MSE_titulo2.setText("Titulo");
        lbl_MSE_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MSE_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 650, 80, 25));
        jp_Componentes.add(txt_MSE_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 650, 130, 25));

        lbl_MSE_titulo1.setText("Titulo");
        lbl_MSE_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MSE_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 650, 300, 30));
        ...
        jp_Componentes.add(btn_MSE_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 650, 25, 25));

        lbl_MRD_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MRD_error.setText(" . . .");
        jp_Componentes.add(lbl_MRD_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 690, 340, 35));

        lbl_MRD_titulo2.setText("Titulo");
        lbl_MRD_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MRD_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 690, 80, 25));
        jp_Componentes.add(txt_MRD_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 690, 130, 25));

        lbl_MRD_titulo1.setText("Titulo");
        lbl_MRD_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MRD_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 690, 300, 30));
        ...
        jp_Componentes.add(btn_MDB_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 610, 25, 25));

        lbl_MST_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MST_error.setText(" . . .");
        jp_Componentes.add(lbl_MST_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 730, 340, 35));

        lbl_MST_titulo2.setText("Titulo");
        lbl_MST_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MST_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 730, 80, 25));
        jp_Componentes.add(txt_MST_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 730, 130, 25));

        lbl_MST_titulo1.setText("Titulo");
        lbl_MST_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MST_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 730, 300, 30));

        lbl_MSR_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MSR_error.setText(" . . .");
        jp_Componentes.add(lbl_MSR_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 770, 340, 35));

        lbl_MSR_titulo2.setText("Titulo");
        lbl_MSR_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MSR_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 770, 80, 25));
        jp_Componentes.add(txt_MSR_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 770, 130, 25));

        lbl_MSR_titulo1.setText("Titulo");
        lbl_MSR_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MSR_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 770, 300, 30));
        ...
        jp_Componentes.add(btn_MST_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 730, 25, 25));

        lbl_MCC_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MCC_error.setText(" . . .");
        jp_Componentes.add(lbl_MCC_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 810, 340, 35));

        lbl_MCC_titulo2.setText("Titulo");
        lbl_MCC_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MCC_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 810, 80, 25));
        jp_Componentes.add(txt_MCC_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 810, 130, 25));

        lbl_MCC_titulo1.setText("Titulo");
        lbl_MCC_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MCC_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 810, 300, 30));
        ...
        jp_Componentes.add(btn_MCC_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 810, 25, 25));

        lbl_MTE_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MTE_error.setText(" . . .");
        jp_Componentes.add(lbl_MTE_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 850, 340, 35));

        lbl_MTE_titulo2.setText("Titulo");
        lbl_MTE_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MTE_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 850, 80, 25));
        jp_Componentes.add(txt_MTE_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 850, 130, 25));

        lbl_MTE_titulo1.setText("Titulo");
        lbl_MTE_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MTE_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 850, 300, 30));
        ...
        jp_Componentes.add(btn_MTE_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 850, 25, 25));
        jp_Componentes.add(jSeparator12, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 972, 1024, 2));

        lbl_MEL_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MEL_error.setText(" . . .");
        jp_Componentes.add(lbl_MEL_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 890, 340, 35));

        lbl_MEL_titulo2.setText("Titulo");
        lbl_MEL_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MEL_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 890, 80, 25));
        jp_Componentes.add(txt_MEL_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 890, 130, 25));

        lbl_MEL_titulo1.setText("Titulo");
        lbl_MEL_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MEL_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 890, 300, 30));
        ...
        jp_Componentes.add(btn_MEL_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 890, 25, 25));

        lbl_MCE_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MCE_error.setText(" . . .");
        jp_Componentes.add(lbl_MCE_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 930, 340, 35));

        lbl_MCE_titulo2.setText("Titulo");
        lbl_MCE_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MCE_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 930, 80, 25));

        txt_MCE_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MCE_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 930, 130, 25));

        lbl_MCE_titulo1.setText("Titulo");
        lbl_MCE_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MCE_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 930, 300, 30));
        ...
        jp_Componentes.add(btn_MCE_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 930, 25, 25));
        ...
        jp_Componentes.add(lbl_MDP_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 980, 610, 30));

        lbl_MDP_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MDP_error.setText(" . . .");
        jp_Componentes.add(lbl_MDP_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1020, 340, 35));

        lbl_MDP_titulo2.setText("Titulo");
        lbl_MDP_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MDP_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1020, 80, 25));

        txt_MDP_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MDP_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1020, 130, 25));

        lbl_MDP_titulo1.setText("Titulo");
        lbl_MDP_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MDP_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1020, 300, 30));
        ...
        jp_Componentes.add(btn_MDP_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1020, 25, 25));

        lbl_MDS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MDS_error.setText(" . . .");
        jp_Componentes.add(lbl_MDS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1060, 340, 35));

        lbl_MDS_titulo2.setText("Titulo");
        lbl_MDS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MDS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1060, 80, 25));

        txt_MDS_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MDS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1060, 130, 25));

        lbl_MDS_titulo1.setText("Titulo");
        lbl_MDS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MDS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1060, 300, 30));
        jp_Componentes.add(jSeparator14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1182, 1024, 2));

        lbl_MES_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MES_error.setText(" . . .");
        jp_Componentes.add(lbl_MES_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1100, 340, 35));

        lbl_MES_titulo2.setText("Titulo");
        lbl_MES_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MES_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1100, 80, 25));

        txt_MES_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MES_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1100, 130, 25));

        lbl_MES_titulo1.setText("Titulo");
        lbl_MES_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MES_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1100, 300, 30));

        lbl_MED_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MED_error.setText(" . . .");
        jp_Componentes.add(lbl_MED_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1140, 340, 35));

        lbl_MED_titulo2.setText("Titulo");
        lbl_MED_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MED_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1140, 80, 25));

        txt_MED_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MED_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1140, 130, 25));

        lbl_MED_titulo1.setText("Titulo");
        lbl_MED_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MED_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1140, 300, 30));
        jp_Componentes.add(jSeparator15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1290, 1024, -1));

        lbl_MPL_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MPL_error.setText(" . . .");
        jp_Componentes.add(lbl_MPL_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1200, 340, 35));

        lbl_MPL_titulo2.setText("Titulo");
        lbl_MPL_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MPL_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1200, 80, 25));

        txt_MPL_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MPL_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1200, 130, 25));

        lbl_MPL_titulo1.setText("Titulo");
        lbl_MPL_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MPL_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1200, 300, 30));
        ...
        jp_Componentes.add(btn_MPL_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1200, 25, 25));

        lbl_MLT_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MLT_error.setText(" . . .");
        jp_Componentes.add(lbl_MLT_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1240, 340, 35));

        lbl_MLT_titulo2.setText("Titulo");
        lbl_MLT_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MLT_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1240, 80, 25));

        txt_MLT_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MLT_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1240, 130, 25));

        lbl_MLT_titulo1.setText("Titulo");
        lbl_MLT_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MLT_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1240, 300, 30));
        jp_Componentes.add(jSeparator11, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1500, 1024, -1));

        lbl_MVL_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MVL_error.setText(" . . .");
        jp_Componentes.add(lbl_MVL_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1310, 340, 35));

        lbl_MVL_titulo2.setText("Titulo");
        lbl_MVL_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MVL_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1310, 80, 25));

        txt_MVL_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MVL_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1310, 130, 25));

        lbl_MVL_titulo1.setText("Titulo");
        lbl_MVL_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MVL_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1310, 300, 30));

        lbl_MVT_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MVT_error.setText(" . . .");
        jp_Componentes.add(lbl_MVT_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1410, 340, 35));

        lbl_MVT_titulo2.setText("Titulo");
        lbl_MVT_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MVT_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1410, 80, 25));

        txt_MVT_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MVT_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1410, 130, 25));

        lbl_MVT_titulo1.setText("Titulo");
        lbl_MVT_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MVT_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1410, 300, 30));
        ...
        jp_Componentes.add(btn_MVT_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1410, 25, 25));

        lbl_MVH_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MVH_error.setText(" . . .");
        jp_Componentes.add(lbl_MVH_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1450, 340, 35));

        lbl_MVH_titulo2.setText("Titulo");
        lbl_MVH_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MVH_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1450, 80, 25));

        txt_MVH_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MVH_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1450, 130, 25));

        lbl_MVH_titulo1.setText("Titulo");
        lbl_MVH_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MVH_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1450, 300, 30));
        ...
        jp_Componentes.add(btn_MVH_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1450, 25, 25));

        lbl_MPT_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MPT_error.setText(" . . .");
        jp_Componentes.add(lbl_MPT_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1550, 340, 35));

        lbl_MPT_titulo2.setText("Titulo");
        lbl_MPT_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MPT_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1550, 80, 25));
        jp_Componentes.add(txt_MPT_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1550, 130, 25));

        lbl_MPT_titulo1.setText("Titulo");
        lbl_MPT_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MPT_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1550, 300, 30));

        lbl_MAS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MAS_error.setText(" . . .");
        jp_Componentes.add(lbl_MAS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1590, 340, 35));

        lbl_MAS_titulo2.setText("Titulo");
        lbl_MAS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MAS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1590, 80, 25));

        txt_MAS_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MAS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1590, 130, 25));

        lbl_MAS_titulo1.setText("Titulo");
        lbl_MAS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MAS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1590, 300, 30));
        ...
        jp_Componentes.add(btn_MPT_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(630, 1510, 25, 25));
        jp_Componentes.add(jSeparator16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1632, 1024, 2));
        ...
        jp_Componentes.add(lbl_MPT_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1510, 610, 30));
        jp_Componentes.add(jSeparator17, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1772, 1024, 2));

        lbl_MRM_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MRM_error.setText(" . . .");
        jp_Componentes.add(lbl_MRM_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1690, 340, 35));

        lbl_MRM_titulo2.setText("Titulo");
        lbl_MRM_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MRM_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1690, 80, 25));

        txt_MRM_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MRM_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1690, 130, 25));

        lbl_MRM_titulo1.setText("Titulo");
        lbl_MRM_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MRM_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1690, 300, 30));

        lbl_MEC_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MEC_error.setText(" . . .");
        jp_Componentes.add(lbl_MEC_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1730, 340, 35));

        lbl_MEC_titulo2.setText("Titulo");
        lbl_MEC_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MEC_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1730, 80, 25));

        txt_MEC_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MEC_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1730, 130, 25));

        lbl_MEC_titulo1.setText("Titulo");
        lbl_MEC_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MEC_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1730, 300, 30));
        ...
        jp_Componentes.add(btn_MEC_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1730, 25, 25));

        lbl_MFS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MFS_error.setText(" . . .");
        jp_Componentes.add(lbl_MFS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1820, 340, 35));

        lbl_MFS_titulo2.setText("Titulo");
        lbl_MFS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MFS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1820, 80, 25));
        jp_Componentes.add(txt_MFS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1820, 130, 25));

        lbl_MFS_titulo1.setText("Titulo");
        lbl_MFS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MFS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1820, 300, 30));
        ...
        jp_Componentes.add(btn_MFS_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1820, 25, 25));

        lbl_MSA_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MSA_error.setText(" . . .");
        jp_Componentes.add(lbl_MSA_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1860, 340, 35));

        lbl_MSA_titulo2.setText("Titulo");
        lbl_MSA_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MSA_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1860, 80, 25));

        txt_MSA_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MSA_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1860, 130, 25));

        lbl_MSA_titulo1.setText("Titulo");
        lbl_MSA_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MSA_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1860, 300, 30));
        ...
        jp_Componentes.add(btn_MSA_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1860, 25, 25));

        lbl_MAM_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MAM_error.setText(" . . .");
        jp_Componentes.add(lbl_MAM_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1650, 340, 35));

        lbl_MAM_titulo2.setText("Titulo");
        lbl_MAM_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MAM_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1650, 80, 25));

        txt_MAM_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MAM_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1650, 130, 25));

        lbl_MAM_titulo1.setText("Titulo");
        lbl_MAM_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MAM_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1650, 300, 30));
        ...
        jp_Componentes.add(btn_MRM_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1690, 25, 25));
        jp_Componentes.add(jSeparator18, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1902, 1024, 2));

        lbl_MMS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MMS_error.setText(" . . .");
        jp_Componentes.add(lbl_MMS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1960, 340, 35));

        lbl_MMS_titulo2.setText("Titulo");
        lbl_MMS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MMS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1960, 80, 25));

        txt_MMS_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MMS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1960, 130, 25));

        lbl_MMS_titulo1.setText("Titulo");
        lbl_MMS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MMS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1960, 300, 30));
        ...
        jp_Componentes.add(btn_MMS_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1960, 25, 25));

        lbl_MHS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MHS_error.setText(" . . .");
        jp_Componentes.add(lbl_MHS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 2000, 340, 35));

        lbl_MHS_titulo2.setText("Titulo");
        lbl_MHS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MHS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 2000, 80, 25));
        jp_Componentes.add(txt_MHS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 2000, 130, 25));

        lbl_MHS_titulo1.setText("Titulo");
        lbl_MHS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MHS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 2000, 300, 30));
        ...
        jp_Componentes.add(btn_MHS_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 2000, 25, 25));
        ...
        jp_Componentes.add(lbl_MMS_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1920, 610, 30));

        lbl_MAT_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_MAT_error.setText(" . . .");
        jp_Componentes.add(lbl_MAT_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 2040, 340, 35));

        lbl_MAT_titulo2.setText("Titulo");
        lbl_MAT_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MAT_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 2040, 80, 25));

        txt_MAT_Pregunta.setEditable(false);
        jp_Componentes.add(txt_MAT_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 2040, 130, 25));

        lbl_MAT_titulo1.setText("Titulo");
        lbl_MAT_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_MAT_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 2040, 300, 30));
        ...
        jp_Componentes.add(btn_MVL_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1310, 25, 25));
        ...
        jp_Componentes.add(lbl_MDB_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 570, 610, 30));
        ...
        jp_Componentes.add(btn_MSR_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 770, 25, 25));
        jp_Componentes.add(jSeparator19, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1360, 1024, 2));
        ...
        jp_Componentes.add(lbl_MVT_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1370, 610, 30));
        ...
        jp_Componentes.add(btn_MPT_ayuda1, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1550, 25, 25));
        ...
        jp_Componentes.add(btn_MAM_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1650, 25, 25));
        ...
        jp_Componentes.add(lbl_MFS_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1780, 610, 30));
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addComponent(jsp_LodosActivadosModConv, javax.swing.GroupLayout.DEFAULT_SIZE, 2226, Short.MAX_VALUE)
                .addContainerGap())
        );
