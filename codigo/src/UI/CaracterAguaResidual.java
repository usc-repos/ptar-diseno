...
public class CaracterAguaResidual extends javax.swing.JInternalFrame {
    ...
    private boolean CalcularCAB() {
        ...
        try {
            ...
            if (txt_CAB_Pregunta.getText().trim().equals("") || txt_CAB_Pregunta.getText().trim().equals("0")) { //No es obligatoria
    ...
    private boolean CalcularCAS() {
        ...
        try {
            ...
            if (txt_CAS_Pregunta.getText().trim().equals("") || txt_CAS_Pregunta.getText().trim().equals("0")) { //No es obligatoria
    ...
    private boolean CalcularCAV() {
        ...
        try {
            ...
            if (txt_CAV_Pregunta.getText().trim().equals("") || txt_CAV_Pregunta.getText().trim().equals("0")) { //No es obligatoria
    ...
    private void cerrar() {
        ...
        main.bod.WinCaractInicAguaResidual = false;
    ...
    private void initComponents() {
        ...
        txt_CAQ_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        txt_CAT_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        txt_CAB_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        txt_CAS_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        txt_CAV_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
