...
public class FiltroPercolador extends javax.swing.JInternalFrame {
    ...
    public void InicializarComponentes() {
        ...
        try {
            ...
            txt_Q3C_Pregunta.setText(bod.getVarFormateada(bod.calcularQ3Cm3Dia(), rs.getInt("decimales"))); //en m³/dia
            // - - - - - - Dato 3 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - UECQ Si no existe DBO se usa DQO, si CAB !=0 usar UEC si no usar UEQ
            if (bod.getVarDob("CAB") != 0) {
                rs = db.ResultadoSelect("datospregunta", "UEQ"); //DBO

                lbl_UECQ_titulo1.setText(rs.getString("titulo1"));
                lbl_UECQ_titulo2.setText(rs.getString("titulo2"));
                txt_UECQ_Pregunta.setText(bod.getVarFormateadaPorNombre("UEQ", rs.getInt("decimales")));
            } else {
                rs = db.ResultadoSelect("datospregunta", "UEC"); //DQO

                lbl_UECQ_titulo1.setText(rs.getString("titulo1"));
                lbl_UECQ_titulo2.setText(rs.getString("titulo2"));
                txt_UECQ_Pregunta.setText(bod.getVarFormateadaPorNombre("UEC", rs.getInt("decimales")));
            }
            ...
            AsignarPopupBtn(btn_PCO_ayuda, rs.getString("ayuda"), rs.getString("ayudalink"), 520, 480);
            ...
            AsignarPopupBtn(btn_PPM_ayuda, rs.getString("ayuda"), rs.getString("ayudalink"), 450, 320);
            ...
            AsignarPopupBtn(btn_PH3_ayuda, rs.getString("ayuda"), rs.getString("ayudalink"), 600, 560);
            ...
            lbl_PER_desc.setText(pg.desc);

            AsignarPopupBtn(btn_PER_ayuda, rs.getString("ayuda"), rs.getString("ayudalink"), 470, 410);
            // - - - - - - Pregunta 10a Cuestionario 11 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - PEQ (Si existe DBO de UASB se usa PEQ)
            if (bod.getVarDob("CAB") != 0) {
                rs = db.ResultadoSelect("datospregunta", "PEQ");
                ...
                lbl_PEQ_titulo1.setText(pg.tit1);
                lbl_PEQ_titulo2.setText(rs.getString("titulo2"));
            } else {
                lbl_PEQ_titulo1.setVisible(false);
                lbl_PEQ_titulo2.setVisible(false);
                txt_PEQ_Pregunta.setVisible(false);
                lbl_PEQ_error.setVisible(false);
            }
            ...
            lbl_PCD_desc.setText(pg.desc);
            // - - - - - - Pregunta 11a Cuestionario 11 - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - - PCB (Si existe DBO de UASB se usa PCB)
            if (bod.getVarDob("CAB") != 0) {
                rs = db.ResultadoSelect("datospregunta", "PCB");
                ...
                lbl_PCB_titulo1.setText(pg.tit1);
                lbl_PCB_titulo2.setText(rs.getString("titulo2"));
            } else {
                lbl_PCB_titulo1.setVisible(false);
                lbl_PCB_titulo2.setVisible(false);
                txt_PCB_Pregunta.setVisible(false);
                lbl_PCB_error.setVisible(false);
            }
            ...
            if (bod.EditFiltroPercolador) {
                ...
                txt_PCO_Pregunta.setText(bod.getVarFormateadaPorNombre("PCO", map.get("PCO").deci));
                txt_PVM_Pregunta.setText(bod.getVarFormateadaPorNombre("PVM", map.get("PVM").deci));
                txt_PPM_Pregunta.setText(bod.getVarFormateadaPorNombre("PPM", map.get("PPM").deci));
                ...
                txt_PFU_Pregunta.setText(bod.getVarFormateadaPorNombre("PFU", map.get("PFU").deci));
                ...
                txt_PER_Pregunta.setText(bod.getVarFormateadaPorNombre("PER", map.get("PER").deci));

                if (bod.getVarDob("CAB") != 0) {
                    txt_PEQ_Pregunta.setText(bod.getVarFormateadaPorNombre("PEQ", map.get("PEQ").deci));
                }

                txt_PCD_Pregunta.setText(bod.getVarFormateadaPorNombre("PCD", map.get("PCD").deci));

                if (bod.getVarDob("CAB") != 0) {
                    txt_PCB_Pregunta.setText(bod.getVarFormateadaPorNombre("PCB", map.get("PCB").deci));
                }
                ...
                txt_PSS_Pregunta.setText(bod.getVarFormateadaPorNombre("PSS", map.get("PSS").deci));
                ...
                txt_PNU_Pregunta.setText(bod.getVarFormateadaPorNombre("PNU", map.get("PNU").deci));
    ...
    private boolean Guardar() {
        ...
        if (bod.getVarDob("CAB") != 0) {
            if (!CalcularPEQ()) {
                lbl_save_error.setText(map.get("PEQ").erro);
                lbl_save_error2.setText(map.get("PEQ").tit1 + " . " + map.get("PEQ").desc);
                return false;
            }
        } else {
            bod.setVarDob(0, "PEQ", 0, 1);
        }
        ...
        if (bod.getVarDob("CAB") != 0) {
            if (!CalcularPCB()) {
                lbl_save_error.setText(map.get("PCB").erro);
                lbl_save_error2.setText(map.get("PCB").tit1 + " . " + map.get("PCB").desc);
                return false;
            }
        } else {
            bod.setVarDob(0, "PCB", 0, 1);
        }
        ...
        main.cancela = false;
        main.vbod = this.bod;
        bod.EditFiltroPercolador = true;

        if (!bod.exportarProyecto(true)) {
            bod.EditFiltroPercolador = false;
            main.cancela = false;
            main.vbod = null;
            return false;
        }
     ...
     */
    private boolean CalcularPH2C() { //todo. cambiar esto por mensaje ventana y llamarlo desde PH2

        try {
            String x = bod.calcularPH2C();

            if (lbl_PH2_error.getText().isEmpty()) {
                lbl_PH2_error.setText(x);
                return true;
            }
        } catch (Exception ex) {
            log.error("Error: CalcularPH2C " + ex.getMessage());
        }
        return false;
    }
    ...
    private boolean CalcularPER() {
        ...
        try {
            lbl_PER_error.setText("");
            double x = bod.calcularPER();

            if (bod.setVarDob(x, "PER", map.get("PER").rmin, map.get("PER").rmax)) {
                txt_PER_Pregunta.setText(bod.getVarFormateadaPorNombre("PER", map.get("PER").deci));
                return true;
            }
        } catch (Exception ex) {
    ...
    private boolean CalcularPEQ() {

        if (bod.getVarDob("CAB") == 0) { //no hace nada si no existe
            return true;
        }

        try {
            lbl_PEQ_error.setText("");
            double x = bod.calcularPEQ();

            if (bod.setVarDob(x, "PEQ", map.get("PEQ").rmin, map.get("PEQ").rmax)) {
                txt_PEQ_Pregunta.setText(bod.getVarFormateadaPorNombre("PEQ", map.get("PEQ").deci));
                return true;
            }
        } catch (Exception ex) {
            log.error("Error: CalcularPEQ " + ex.getMessage());
        }
        lbl_PEQ_error.setText(map.get("PEQ").erro);
        return false;
    }
    ...
    private boolean CalcularPCB() {
        ...
        try {
            lbl_PCB_error.setText("");
            double x = bod.calcularPCB();

            if (bod.setVarDob(x, "PCB", map.get("PCB").rmin, map.get("PCB").rmax)) {
                txt_PCB_Pregunta.setText(bod.getVarFormateadaPorNombre("PCB", map.get("PCB").deci));
                return true;
            }
        } catch (Exception ex) {
            log.error("Error: CalcularPCB " + ex.getMessage());
        }
        lbl_PCB_error.setText(map.get("PCB").erro);
        return false;
    }
    ...
    private void cerrar() {
        ...
        Main main = (Main) this.getTopLevelAncestor();
        main.bod.WinFiltroPercolador = false;
        this.dispose();
    }
    ...
    private void initComponents() {
        ...
        lbl_UECQ_titulo2 = new javax.swing.JLabel();
        txt_UECQ_Pregunta = new javax.swing.JTextField();
        lbl_UECQ_titulo1 = new javax.swing.JLabel();
        ...
        lbl_PCD_desc = new javax.swing.JLabel();
        ...
        lbl_PEQ_error = new javax.swing.JLabel();
        lbl_PEQ_titulo2 = new javax.swing.JLabel();
        txt_PEQ_Pregunta = new javax.swing.JTextField();
        lbl_PEQ_titulo1 = new javax.swing.JLabel();
        jSeparator15 = new javax.swing.JSeparator();
        lbl_PSS_desc = new javax.swing.JLabel();
        lbl_PER_desc = new javax.swing.JLabel();
        lbl_PCB_error = new javax.swing.JLabel();
        lbl_PCB_titulo2 = new javax.swing.JLabel();
        txt_PCB_Pregunta = new javax.swing.JTextField();
        lbl_PCB_titulo1 = new javax.swing.JLabel();
        ...
        jp_Componentes.setPreferredSize(new java.awt.Dimension(1024, 1500));
        ...
        jp_Componentes.add(btn_guardar, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1380, 120, -1));
        ...
        jp_Componentes.add(btn_close, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1420, 120, 30));

        lbl_save_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_save_error.setText(" . . .");
        jp_Componentes.add(lbl_save_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 1380, 400, 35));

        lbl_save_error2.setForeground(new java.awt.Color(153, 0, 51));
        lbl_save_error2.setText(" . . .");
        jp_Componentes.add(lbl_save_error2, new org.netbeans.lib.awtextra.AbsoluteConstraints(170, 1420, 400, 35));
        ...
        lbl_UECQ_titulo2.setText("Titulo");
        lbl_UECQ_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_UECQ_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 130, 80, 25));

        txt_UECQ_Pregunta.setEditable(false);
        jp_Componentes.add(txt_UECQ_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 130, 130, 25));

        lbl_UECQ_titulo1.setText("Titulo");
        lbl_UECQ_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_UECQ_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 130, 300, 30));

        lbl_PCO_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PCO_error.setText(" . . .");
        jp_Componentes.add(lbl_PCO_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 180, 340, 35));

        lbl_PCO_titulo2.setText("Titulo");
        lbl_PCO_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PCO_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 180, 100, 25));

        txt_PCO_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        lbl_PVM_error.setText(" . . .");
        jp_Componentes.add(lbl_PVM_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 220, 340, 35));
        ...
        lbl_PPM_error.setText(" . . .");
        jp_Componentes.add(lbl_PPM_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 260, 340, 35));
        ...
        txt_PPM_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        lbl_PAS_error.setText(" . . .");
        jp_Componentes.add(lbl_PAS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 300, 340, 35));
        ...
        lbl_PH2_error.setText(" . . .");
        jp_Componentes.add(lbl_PH2_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 380, 350, 35));
        ...
        txt_PFU_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        ...
        lbl_PER_error.setText(" . . .");
        jp_Componentes.add(lbl_PER_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 690, 340, 35));

        lbl_PER_titulo2.setText("Titulo");
        lbl_PER_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PER_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 690, 80, 25));

        txt_PER_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PER_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 690, 130, 25));

        lbl_PER_titulo1.setText("Titulo");
        lbl_PER_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PER_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 690, 300, 30));
        jp_Componentes.add(jSeparator10, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1010, 1024, 2));

        lbl_PCD_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PCD_error.setText(" . . .");
        jp_Componentes.add(lbl_PCD_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 810, 340, 35));

        lbl_PCD_titulo2.setText("Titulo");
        lbl_PCD_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PCD_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 820, 80, 25));

        txt_PCD_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PCD_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 820, 130, 25));

        lbl_PCD_titulo1.setText("Titulo");
        lbl_PCD_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PCD_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 820, 300, 30));
        ...
        jp_Componentes.add(btn_PER_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 690, 25, 25));

        lbl_PEL_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PEL_error.setText(" . . .");
        jp_Componentes.add(lbl_PEL_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 920, 340, 35));

        lbl_PEL_titulo2.setText("Titulo");
        lbl_PEL_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PEL_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 930, 80, 25));

        txt_PEL_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PEL_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 930, 130, 25));

        lbl_PEL_titulo1.setText("Titulo");
        lbl_PEL_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PEL_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 930, 300, 30));
        ...
        jp_Componentes.add(btn_PEL_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 930, 25, 25));

        lbl_PVL_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PVL_error.setText(" . . .");
        jp_Componentes.add(lbl_PVL_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 970, 340, 35));

        lbl_PVL_titulo2.setText("Titulo");
        lbl_PVL_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PVL_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 970, 80, 25));

        txt_PVL_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PVL_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 970, 130, 25));

        lbl_PVL_titulo1.setText("Titulo");
        lbl_PVL_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PVL_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 970, 300, 30));

        lbl_PCD_desc.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbl_PCD_desc.setForeground(new java.awt.Color(51, 51, 51));
        lbl_PCD_desc.setText("Desc");
        lbl_PCD_desc.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PCD_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 780, 610, 30));

        lbl_PSS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PSS_error.setText(" . . .");
        jp_Componentes.add(lbl_PSS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1060, 340, 35));

        lbl_PSS_titulo2.setText("Titulo");
        lbl_PSS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PSS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1060, 80, 25));

        txt_PSS_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        jp_Componentes.add(txt_PSS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1060, 130, 25));

        lbl_PSS_titulo1.setText("Titulo");
        lbl_PSS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PSS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1060, 300, 30));
        ...
        jp_Componentes.add(btn_PSS_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1060, 25, 25));

        lbl_PSA_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PSA_error.setText(" . . .");
        jp_Componentes.add(lbl_PSA_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1100, 340, 35));

        lbl_PSA_titulo2.setText("Titulo");
        lbl_PSA_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PSA_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1100, 80, 25));

        txt_PSA_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PSA_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1100, 130, 25));

        lbl_PSA_titulo1.setText("Titulo");
        lbl_PSA_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PSA_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1100, 300, 30));
        jp_Componentes.add(jSeparator13, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1300, 1024, -1));

        lbl_PPS_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PPS_error.setText(" . . .");
        jp_Componentes.add(lbl_PPS_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1140, 340, 35));

        lbl_PPS_titulo2.setText("Titulo");
        lbl_PPS_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PPS_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1140, 80, 25));

        txt_PPS_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PPS_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1140, 130, 25));

        lbl_PPS_titulo1.setText("Titulo");
        lbl_PPS_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PPS_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1140, 300, 30));
        ...
        jp_Componentes.add(btn_PPS_ayuda, new org.netbeans.lib.awtextra.AbsoluteConstraints(320, 1140, 25, 25));

        lbl_PNU_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PNU_error.setText(" . . .");
        jp_Componentes.add(lbl_PNU_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1180, 340, 35));

        lbl_PNU_titulo2.setText("Titulo");
        lbl_PNU_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PNU_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1180, 80, 25));

        txt_PNU_Pregunta.setBackground(new java.awt.Color(230, 241, 255));
        jp_Componentes.add(txt_PNU_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1180, 130, 25));

        lbl_PNU_titulo1.setText("Titulo");
        lbl_PNU_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PNU_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1180, 300, 30));
        jp_Componentes.add(jSeparator14, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 1360, 1024, -1));

        lbl_PAT_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PAT_error.setText(" . . .");
        jp_Componentes.add(lbl_PAT_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1320, 340, 35));

        lbl_PAT_titulo2.setText("Titulo");
        lbl_PAT_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PAT_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1320, 80, 25));

        txt_PAT_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PAT_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1320, 130, 25));

        lbl_PAT_titulo1.setText("Titulo");
        lbl_PAT_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PAT_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1320, 300, 30));
        ...
        lbl_PAX_error.setText(" . . .");
        jp_Componentes.add(lbl_PAX_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1220, 340, 35));

        lbl_PAX_titulo2.setText("Titulo");
        lbl_PAX_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PAX_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1220, 80, 25));

        txt_PAX_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PAX_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1220, 130, 25));

        lbl_PAX_titulo1.setText("Titulo");
        lbl_PAX_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PAX_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1220, 300, 30));

        lbl_PDX_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PDX_error.setText(" . . .");
        jp_Componentes.add(lbl_PDX_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 1260, 340, 35));

        lbl_PDX_titulo2.setText("Titulo");
        lbl_PDX_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PDX_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 1260, 80, 25));

        txt_PDX_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PDX_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 1260, 130, 25));

        lbl_PDX_titulo1.setText("Titulo");
        lbl_PDX_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PDX_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1260, 300, 30));

        lbl_PEQ_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PEQ_error.setText(" . . .");
        jp_Componentes.add(lbl_PEQ_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 730, 340, 35));

        lbl_PEQ_titulo2.setText("Titulo");
        lbl_PEQ_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PEQ_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 730, 80, 25));

        txt_PEQ_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PEQ_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 730, 130, 25));

        lbl_PEQ_titulo1.setText("Titulo");
        lbl_PEQ_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PEQ_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 730, 300, 30));
        jp_Componentes.add(jSeparator15, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 772, 1024, 2));
        ...
        jp_Componentes.add(lbl_PSS_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 1020, 610, 30));

        lbl_PER_desc.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        lbl_PER_desc.setForeground(new java.awt.Color(51, 51, 51));
        lbl_PER_desc.setText("Desc");
        lbl_PER_desc.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PER_desc, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 650, 610, 30));

        lbl_PCB_error.setForeground(new java.awt.Color(153, 0, 51));
        lbl_PCB_error.setText(" . . .");
        jp_Componentes.add(lbl_PCB_error, new org.netbeans.lib.awtextra.AbsoluteConstraints(600, 860, 340, 35));

        lbl_PCB_titulo2.setText("Titulo");
        lbl_PCB_titulo2.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PCB_titulo2, new org.netbeans.lib.awtextra.AbsoluteConstraints(510, 860, 80, 25));

        txt_PCB_Pregunta.setEditable(false);
        jp_Componentes.add(txt_PCB_Pregunta, new org.netbeans.lib.awtextra.AbsoluteConstraints(370, 860, 130, 25));

        lbl_PCB_titulo1.setText("Titulo");
        lbl_PCB_titulo1.setCursor(new java.awt.Cursor(java.awt.Cursor.DEFAULT_CURSOR));
        jp_Componentes.add(lbl_PCB_titulo1, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 860, 300, 30));
        jp_Componentes.add(jSeparator16, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 912, 1024, 2));
    ...
    private javax.swing.JLabel lbl_PCB_error;
    private javax.swing.JLabel lbl_PCB_titulo1;
    private javax.swing.JLabel lbl_PCB_titulo2;
    private javax.swing.JLabel lbl_PCD_desc;
    ...
    private javax.swing.JLabel lbl_PEQ_error;
    private javax.swing.JLabel lbl_PEQ_titulo1;
    private javax.swing.JLabel lbl_PEQ_titulo2;
    private javax.swing.JLabel lbl_PER_desc;
    ...
    private javax.swing.JLabel lbl_UECQ_titulo1;
    private javax.swing.JLabel lbl_UECQ_titulo2;
    ...
    private javax.swing.JTextField txt_PCB_Pregunta;
    ...
    private javax.swing.JTextField txt_PEQ_Pregunta;
    ...
    private javax.swing.JTextField txt_UECQ_Pregunta;
